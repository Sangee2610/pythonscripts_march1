...
input_file = "/home/baadmin/NCT_ETL/input_files/pg_extract_prd/Salesforce_Practitioner_rate_extract.csv"

sf_fields = ['Name__c', 'ContactKey__c', 'Contact__c', 'Pay_Band__c', 
            'Boundary__c', 'Start_Date__c', 'End_Date__c', 'Id', 
            'Cost__c']
...
cur.execute("""
DROP TABLE IF EXISTS prd_landing_practitioner_rate_id;
CREATE TABLE prd_landing_practitioner_rate_id(
Name text,
ContactKey text,
Contact text,
PayBand text,
...
ddsample = '/home/baadmin/NCT_ETL/input_files/pg_extract_prd/Salesforce_Practitioner_rate_extract.csv'
...
def data_cleaning_loading(filename):
    ...
    g.close()
    g = open(new_filename)
    cur.copy_from(g, 'prd_landing_practitioner_rate_id',  sep=",")
    conn.commit()
    g.close()
    f.close()
...
cur.execute("""
DROP TABLE IF EXISTS prd_staging_practitioner_rate_id;
CREATE TABLE prd_staging_practitioner_rate_id AS
SELECT 
Name,
ContactKey,
Contact,
...
id,
'CARE' as datasource
from prd_landing_practitioner_rate_id
""")
