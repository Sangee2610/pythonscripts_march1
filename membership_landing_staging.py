...
WHEN Membership_Type = 'VI' THEN '1 year volunteer/practr - Ind'
WHEN Membership_Type = 'VJ' THEN '1 year volunteer/practr - Jnt'
...
Cancelation_Reason,
Canceled_By,
Membership_Term as MembershipPeriod,
Renewal_Date,
Payment_Method,
